...
static OSStatus renderCallbacktan(
                               void*                       inRefCon,
...
static OSStatus renderCallbacksin(
                                  void*                       inRefCon,
                                  AudioUnitRenderActionFlags* ioActionFlags,
                                  const AudioTimeStamp*       inTimeStamp,
                                  UInt32                      inBusNumber,
...
- (void)prepareAudioUnit{
    ...
    if(sw != 0){
        callbackStruct.inputProc = renderCallbacksin;
        sw = 1;
        NSLog(@"Sin!");
    } else {
    callbackStruct.inputProc = renderCallbacktan;
        sw = 0;
        NSLog(@"Tan!");
    }
    //コールバック関数の設定
